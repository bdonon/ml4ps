...
class H2MGNODE(flax.struct.PyTreeNode):
    ...
    def make(cls,
             ...
             local_dynamics_hidden_size: Sequence[int],
             global_dynamics_hidden_size: Sequence[int],
             local_decoder_hidden_size: Sequence[int],
             global_decoder_hidden_size: Sequence[int],
             local_latent_dimension: int,
             global_latent_dimension: int,
