...
class Classifier(BaseModel):
    ...
    def __init__(self, problem=None, normalizer=None, normalizer_args=None, nn_type="h2mgnode", np_random=None, **nn_args) -> None:
        ...
        self.normalizer = normalizer or Normalizer(backend=problem.backend, data_dir=problem.data_dir, **normalizer_args)
        self.nn = ml4ps.neural_network.get(nn_type, {"feature_dimension":problem.output_space.discrete.feature_dimension, **nn_args})
    ...
    def loss(self, params, x, y):
        ...
        return ((y_hat_norm-y_norm)**2).nanmean()
