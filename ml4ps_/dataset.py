...
class PowerGridDataset(Dataset):
    ...
    def __init__(self, data_dir=None, backend=None, **kwargs):
        ...
        Args:
            ...
            backend (:obj:`ml4ps_.backend.interface.Backend`): Power Systems backend that can load power grid
                instances, get and set power grid features, and perform Power Flow simulations.
            normalizer (:obj:`ml4ps_.normalization.Normalizer`, optional): Feature normalizer that can transform
