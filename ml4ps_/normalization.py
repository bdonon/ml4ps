...
from ml4ps_.backend.interface import collate
...
class Normalizer:
    ...
    Attributes:
        functions (:obj:`dict` of :obj:`dict` of :obj:`ml4ps_.normalization.NormalizationFunction`): Dict of dict of
    ...
    def __init__(self, filename=None, **kwargs):
        ...
        Args:
            ...
            backend (:obj:`ml4ps_.backend.interface.Backend`): Backend to use to extract features.
